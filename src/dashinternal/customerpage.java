       ...
       if(rowindex<0){
           JOptionPane.showMessageDialog(null, "Please Select an Item!");
            ...
            customerinfo ci = new customerinfo();
                ...
                ci.accountid.setText(""+model.getValueAt(rowindex, 1));
                ci.customerfname.setText(""+model.getValueAt(rowindex, 2));
                ci.customerlname.setText(""+model.getValueAt(rowindex, 3));
                ci.customergender.setSelectedItem(""+model.getValueAt(rowindex, 4).toString());
                ci.customercontact.setText(""+model.getValueAt(rowindex, 5));
                ci.customerbirthdate.setToolTipText(""+model.getValueAt(rowindex, 6).toString());
                ci.customercountry.setSelectedItem(""+model.getValueAt(rowindex, 7).toString());
                ci.setVisible(true);
                ci.action = "Edit";
        ...
        if(rowindex < 0){
            ...
            int a = JOptionPane.showConfirmDialog(null, "Are you sure to Delete ID: " +id);
                if(a == JOptionPane.YES_OPTION){
                    ...
                    dbc.deleteData(c_id, "tbl_customer");
                    displaydata();
                }
        }
